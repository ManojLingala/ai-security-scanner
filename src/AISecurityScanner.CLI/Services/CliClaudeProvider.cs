...
{
    public class CliClaudeProvider : IAIProvider
    {
        private readonly HttpClient _httpClient;
        private readonly ILogger<CliClaudeProvider> _logger;
        ...
        public CliClaudeProvider(
            HttpClient httpClient, 
            ILogger<CliClaudeProvider> logger, 
        ...
        private async Task EnsureApiKeyAsync()
        {
            ...
            {
                throw new InvalidOperationException("Claude API token not configured. Run 'aiscan auth login' to authenticate.");
            }

            // Update the HTTP client headers with the current token
        ...
        // Copy all the private helper methods from the original ClaudeProvider
